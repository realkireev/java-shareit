...
@SpringBootTest(classes = RequestClientTest.class)
public class RequestClientTest {
    ...
    public void testCreateBooking() {
        ...
        ResponseEntity<Object> result = requestClient.create(requestRequestDto, userId);
    ...
    public void testFindAllBookings() {
        ...
        ResponseEntity<Object> result = requestClient.findAll(userId, 0, 20);
    ...
    public void testFindBookingsByUserId() {
        ...
        ResponseEntity<Object> result = requestClient.findByUserId(userId);
    ...
    public void testFindRequestById() {
        ...
        ResponseEntity<Object> result = requestClient.findById(requestId, userId);
