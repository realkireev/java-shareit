...
@SpringBootTest(classes = BookingCacheServiceTest.class)
public class BookingCacheServiceTest {
    ...
    private final BookingCacheService bookingCacheService = new BookingCacheService(bookingClient);
    ...
    public void testCreateBooking() {
        ...
        ResponseEntity<Object> result = bookingCacheService.create(userId, bookingRequestDto);
    ...
    public void testApproveBooking() {
        ...
        ResponseEntity<Object> result = bookingCacheService.approve(bookingId, userId, approved);
    ...
    public void testFindBookingById() {
        ...
        ResponseEntity<Object> result = bookingCacheService.findById(userId, bookingId);
    ...
    public void testFindAllBookingByUserIdAndState() {
        ...
        ResponseEntity<Object> result = bookingCacheService.findAllByUserIdAndState(userId, "ALL", 0, 20);
    ...
    public void testFindAllBookingByOwnerIdAndState() {
        ...
        ResponseEntity<Object> result = bookingCacheService.findAllByOwnerIdAndState(userId, "ALL", 0, 20);
