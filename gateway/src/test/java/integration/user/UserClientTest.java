...
@SpringBootTest(classes = UserClientTest.class)
public class UserClientTest {
    ...
    public void testCreateUser() {
        ...
        ResponseEntity<Object> result = userClient.create(userRequestDto);
    ...
    public void testUpdateUser() {
        ...
        ResponseEntity<Object> result = userClient.update(userRequestDto, 1L);
    ...
    public void testDeleteUser() {
        ...
        ResponseEntity<Object> result = userClient.delete(1L);
    ...
    public void testFindUserById() {
        ...
        ResponseEntity<Object> result = userClient.findById(1L);
